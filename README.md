...
|---|---|---|---|
| Misael Andre Cieza Armas | Diseño Hardware | Alumno de Ingeniería biomédica con interés en ingeniería clínica y inteligencia artificial | misael.cieza@upch.pe |
| José David Bueno Nogueira | Diseño de Software | Alumno de Ingenieria Biomedica con interés en ... | jose.bueno@upch.pe |
| Mariano Alarcón Tirado  | Diseño 3d y Ensamblaje | Alumno de Ingenieria Biomedica con interés en ... | mariano.alarcon@upch.pe |
| Jorge Rodrigo de la Cruz Blas | Diseño Hardware | Alumno de Ingenieria Biomedica con interés en ... | jorge.de.la.cruz@upch.pe |
| Diego Alberto Ugarte Yupanqui | Desarrollo de ML | Alumno de Ingenieria Biomedica con interés en ... | diego.ugarte.y@upch.pe |
| Juan Antonio Tinoco Quispe | Lider y Desarrollo de ML | Alumno de Ingenieria Biomedica con interés en ... | juan.tinoco@upch.pe |
---
## 📸 Foto grupal
